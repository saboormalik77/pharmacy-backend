-- Function : add_items_to_custom_package
-- Arguments: p_pharmacy_id uuid, p_package_id uuid, p_items jsonb
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.add_items_to_custom_package(p_pharmacy_id uuid, p_package_id uuid, p_items jsonb) CASCADE;

CREATE OR REPLACE FUNCTION public.add_items_to_custom_package(p_pharmacy_id uuid, p_package_id uuid, p_items jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
