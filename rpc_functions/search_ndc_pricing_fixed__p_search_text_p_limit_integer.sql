-- Function : search_ndc_pricing_fixed
-- Arguments: p_search text, p_limit integer
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.search_ndc_pricing_fixed(p_search text, p_limit integer) CASCADE;

CREATE OR REPLACE FUNCTION public.search_ndc_pricing_fixed(p_search text, p_limit integer DEFAULT 50)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
