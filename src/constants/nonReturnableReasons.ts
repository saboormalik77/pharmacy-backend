/**
 * Non-returnable reason codes used across the app (backend mirror).
 *
 ...
 * marked as `non_returnable`.
 *
 * Keep this file in sync with:
 *   - Frontend/lib/constants/nonReturnableReasons.ts
 *   - MainAdmin/lib/constants/nonReturnableReasons.ts
 *   - admin/lib/constants/nonReturnableReasons.ts
 *   - scripts/fcr_52_non_returnable_in_lists_and_memos.sql
 */
...
export const NON_RETURNABLE_REASON_VALUES: string[] = NON_RETURNABLE_REASONS.map(r => r.value);
