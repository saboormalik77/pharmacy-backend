-- Function : update_return_transaction_item
-- Arguments: p_item_id uuid, p_updates jsonb
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.update_return_transaction_item(p_item_id uuid, p_updates jsonb) CASCADE;

CREATE OR REPLACE FUNCTION public.update_return_transaction_item(p_item_id uuid, p_updates jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
