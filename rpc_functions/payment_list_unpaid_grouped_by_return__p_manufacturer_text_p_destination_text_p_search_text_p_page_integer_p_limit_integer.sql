...
DROP FUNCTION IF EXISTS public.payment_list_unpaid_grouped_by_return(p_manufacturer text, p_destination text, p_search text, p_page integer, p_limit integer, uuid[]) CASCADE;
