-- Function : get_package_recommendations
-- Arguments: p_pharmacy_id uuid
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.get_package_recommendations(p_pharmacy_id uuid) CASCADE;

CREATE OR REPLACE FUNCTION public.get_package_recommendations(p_pharmacy_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
