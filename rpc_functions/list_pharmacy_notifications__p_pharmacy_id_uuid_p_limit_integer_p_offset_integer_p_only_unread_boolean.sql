-- Function : list_pharmacy_notifications
-- Arguments: p_pharmacy_id uuid, p_limit integer, p_offset integer, p_only_unread boolean
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.list_pharmacy_notifications(p_pharmacy_id uuid, p_limit integer, p_offset integer, p_only_unread boolean) CASCADE;

CREATE OR REPLACE FUNCTION public.list_pharmacy_notifications(p_pharmacy_id uuid, p_limit integer, p_offset integer, p_only_unread boolean)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
