-- FCR 43 — delete_return_transaction_item_with_validation must recalculate return_transactions
-- totals (total_items, total_returnable_value, total_non_returnable_value). Without this, the
-- returns list and any UI using totalItems stays stale after deleting the last item.
