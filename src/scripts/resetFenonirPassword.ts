...
/**
 * Script to reset password for fenonir863@lxbeta.com
 * Usage: npx ts-node src/scripts/resetFenonirPassword.ts
 */
...
const EMAIL = 'fenonir863@lxbeta.com';
const NEW_PASSWORD = 'Pharmacy123!'; // You can change this to any password you want
