...
<tbody className="divide-y" style={{ borderColor: 'var(--outline-variant)' }}>
                ...
                {wcModal && (
                    <div className="fixed inset-0 bg-gray-900/50 backdrop-blur-md flex cursor-pointer items-center justify-center z-50 p-4" onClick={() => setWcModal(false)}>
                                                    ...
                                                    <tr key={item.id} className="hover:bg-[var(--surface-container)]" style={{ borderColor: 'var(--outline-variant)' }}>
                                                        ...
                                                        <td className="px-3 py-3 text-sm text-gray-900 max-w-[200px] truncate" title={item.productName || ''}>
                                                            <div>
                                                                ...
                                                                {item.manufacturer && (
                                                                    <p className="text-gray-400 truncate text-xs">{item.manufacturer}</p>
                                                                )}
                                                                {item.lotNumber && (
                                                                    <p className="text-gray-500 truncate text-xs">Lot: {item.lotNumber}</p>
                                                                )}
                                                            </div>
                                                        </td>
