-- Function : get_historical_earnings
-- Arguments: p_pharmacy_id uuid, p_period_type text, p_start_date date, p_end_date date
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.get_historical_earnings(p_pharmacy_id uuid, p_period_type text, p_start_date date, p_end_date date) CASCADE;

CREATE OR REPLACE FUNCTION public.get_historical_earnings(p_pharmacy_id uuid, p_period_type text, p_start_date date, p_end_date date)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
