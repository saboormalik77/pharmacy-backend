...
DROP FUNCTION IF EXISTS public.list_debit_memos(p_batch_id uuid, p_pharmacy_id uuid, p_destination text, p_payment_status text, p_search text, p_page integer, p_limit integer, uuid[]) CASCADE;
