-- Function : get_pharmacy_destruction_controls
-- Arguments: p_pharmacy_id uuid, p_ref_num text
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.get_pharmacy_destruction_controls(p_pharmacy_id uuid, p_ref_num text) CASCADE;

CREATE OR REPLACE FUNCTION public.get_pharmacy_destruction_controls(p_pharmacy_id uuid, p_ref_num text)
 RETURNS jsonb
 LANGUAGE plpgsql
