...
DROP FUNCTION IF EXISTS public.get_manifest_data(p_transaction_id uuid) CASCADE;

CREATE OR REPLACE FUNCTION public.get_manifest_data(p_transaction_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
