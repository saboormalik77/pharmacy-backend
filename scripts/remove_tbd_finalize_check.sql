-- Remove TBD status check from finalize_return_transaction function
-- This removes the TBD validation since TBD items are now handled by warehouse verification
