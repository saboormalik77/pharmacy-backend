...
-- Arguments: p_pharmacy_id uuid, p_period_type text, p_periods integer, p_buying_group_id uuid
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.get_admin_dashboard_stats(p_pharmacy_id uuid, p_period_type text, p_periods integer, p_buying_group_id uuid) CASCADE;

CREATE OR REPLACE FUNCTION public.get_admin_dashboard_stats(p_pharmacy_id uuid DEFAULT NULL::uuid, p_period_type text DEFAULT 'monthly'::text, p_periods integer DEFAULT 12, p_buying_group_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
