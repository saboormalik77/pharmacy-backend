...
DROP FUNCTION IF EXISTS public.ra_list_outstanding(text, integer, integer) CASCADE;
DROP FUNCTION IF EXISTS public.ra_list_outstanding(text, integer, integer, uuid[]) CASCADE;
