-- ============================================================
-- FIX: Sort ra_list_tracking results by created_at DESC
-- ============================================================
-- Apply in Supabase SQL Editor:
-- https://supabase.com/dashboard/project/zggtgjbokgfsbenazzpx/sql/new
-- ============================================================
...
GRANT EXECUTE ON FUNCTION ra_list_tracking(TEXT, TEXT, DATE, DATE, TEXT, INTEGER, INTEGER)
