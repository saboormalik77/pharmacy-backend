-- Function : resolve_ndc_price
-- Arguments: p_ndc text
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.resolve_ndc_price(p_ndc text) CASCADE;

CREATE OR REPLACE FUNCTION public.resolve_ndc_price(p_ndc text)
 RETURNS jsonb
 LANGUAGE plpgsql
