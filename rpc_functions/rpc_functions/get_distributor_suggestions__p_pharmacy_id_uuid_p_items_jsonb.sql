-- Function : get_distributor_suggestions
-- Arguments: p_pharmacy_id uuid, p_items jsonb
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.get_distributor_suggestions(p_pharmacy_id uuid, p_items jsonb) CASCADE;

CREATE OR REPLACE FUNCTION public.get_distributor_suggestions(p_pharmacy_id uuid, p_items jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
