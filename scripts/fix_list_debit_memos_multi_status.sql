-- Migration: fix_list_debit_memos_multi_status
-- Allow p_payment_status to be comma-separated (e.g. 'paid,partial') so the
-- Paid Memos tab can show both paid and partial records in one query.

CREATE OR REPLACE FUNCTION public.list_debit_memos(
