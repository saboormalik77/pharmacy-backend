-- Function : get_distributor_package_suggestion
-- Arguments: p_pharmacy_id uuid, p_distributor_id uuid, p_items jsonb
-- Type     : FUNCTION
-- =============================================================

DROP FUNCTION IF EXISTS public.get_distributor_package_suggestion(p_pharmacy_id uuid, p_distributor_id uuid, p_items jsonb) CASCADE;

CREATE OR REPLACE FUNCTION public.get_distributor_package_suggestion(p_pharmacy_id uuid, p_distributor_id uuid, p_items jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
