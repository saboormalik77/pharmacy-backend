-- Fix duplicate item prevention in return transactions
-- This updates the add_return_transaction_item RPC function to prevent duplicates
-- instead of just warning about them.

-- Update the add_return_transaction_item function to prevent duplicates
...
BEGIN
  ...
  INSERT INTO return_transaction_items (
    ...
    standard_price, quantity, quantity_returned, full_package_size,
    ...
    v_price,
    v_qty,
    COALESCE((p_data->>'quantityReturned')::int, v_qty),
