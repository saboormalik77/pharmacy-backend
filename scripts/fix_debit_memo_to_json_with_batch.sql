-- Migration: fix_debit_memo_to_json_with_batch
-- Expose batchName and batchMonth alongside debit memo rows so the warehouse
-- debit-memos page can group memos by their return batch (return) without
-- needing an extra batch fetch.
--
-- Safe to re-run.
